...
# ----- ADAPTIVE CUSTOM CSS (Includes Logo Switch) -------------------------
st.markdown("""
    <style>
    /* ------------------- THEME STYLES ------------------- */
    ...
    /* ------------------- LOGO SWITCH FIX ------------------- */
    /* Dark Mode/Default Logo (light colors/color logo on dark background) */
    .sidebar-logo-container {
        text-align: center;
        margin-bottom: 20px;
        padding: 10px;
        background-image: url("onyxcode_color.png"); /* Default: Dark mode logo (light/color) */
    ...
    @media (prefers-color-scheme: light) {
        .sidebar-logo-container {
            background-image: url("onyxcode_white.png"); /* Light mode logo (dark/black) */
        }
    }
    </style>
...
# ----- LOGO DISPLAY (Using the CSS container) ---------------
...
# ----- SIGNATURE / FOOTER --------------------------
st.markdown('<p class="signature">Made with ❤️ by <b>ONYXCODE</b> using Streamlit | © 2025 Regressify Pro Dashboard</p>', unsafe_allow_html=True)import streamlit as st
import pickle
import pandas as pd
import os
...
st.markdown("""
    ...
    @media (prefers-color-scheme: light) {
        .sidebar-logo-container {
            background-image: url("onyxcode_black.png"); /* Light mode logo (dark/black) */
        }
    }
    </style>
""", unsafe_allow_html=True)
